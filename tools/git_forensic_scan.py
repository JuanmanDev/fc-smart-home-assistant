...
# user-specific credential variants from environment (never hardcoded in source)
_PHONE = os.environ.get("FC_SCAN_PHONE", "")
_PW = os.environ.get("FC_SCAN_PASSWORD", "")
...
if _PW:
    PATTERNS.extend([_PW, _PW[1:] if len(_PW) > 1 else _PW])
