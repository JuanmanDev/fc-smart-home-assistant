"""Deep-dive gateway candidate hosts (ports 2000+3000 = APK gatewayPort+appSystemPort).
...
def main() -> None:
    import os
    hosts = sys.argv[1:] or [os.environ.get("GATEWAY_HOST", "192.168.1.1")]
    targets = [
        (h, [80, 443, 2000, 3000, 8080, 8443])
        for h in hosts
    ]
