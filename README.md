...
1. HACS → ⋮ (top right) → *Custom repositories*, add
   `https://github.com/JuanmanDev/fc-smart-home-assistant` as **Integration**.
...
```powershell
git clone https://github.com/JuanmanDev/fc-smart-home-assistant
cd fc-smart-home-assistant
